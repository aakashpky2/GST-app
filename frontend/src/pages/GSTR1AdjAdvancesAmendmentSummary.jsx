...
const GSTR1AdjAdvancesAmendmentSummary = () => {
    ...
    useEffect(() => {
        const fetchRecords = async () => {
            try {
                ...
                console.error("Failed to fetch Adjustment of Advances records", error);
            }
        };
        fetchRecords();
    }, []);
    ...
    const handleAmend = async () => {
        ...
        try {
            ...
            if (foundRecord) {
                ...
                navigate('/returns/auth/gstr1/txpd/amendment/details', { state: { record: foundRecord, year: financialYear, period: returnFilingPeriod, isDifferential } });
            } else {
                toast.error('No matching Adjustment of Advances record found.');
            }
        } catch (error) {
        ...
        <div className="dashboard-container" style={{ backgroundColor: '#f1f3f6', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="dashboard-breadcrumb-bar">
                <div className="breadcrumb-left">
                    ...
                    <span style={{ color: '#9ca3af', margin: '0 5px' }}>&gt;</span>
                    <span style={{ color: '#4b5563' }}>Amendment of Adjustment of Advances</span>
                </div>
            ...
            <div className="gstr1-main-content" style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto', width: '100%', flex: '1' }}>
                ...
                <div className="b2b-header-banner" style={{ backgroundColor: '#14b8a6', padding: '10px 15px', color: '#fff', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: '15px' }}>
                    <h2 style={{ margin: 0, fontSize: '18px', fontWeight: '500' }}>11B - Amendment of Adjustment of Advances</h2>
...
export default GSTR1AdjAdvancesAmendmentSummary;
