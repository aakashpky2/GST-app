    ...
    return (
        <div style={{ backgroundColor: '#f1f3f6', padding: '20px 120px', minHeight: 'calc(100vh - 200px)' }}>
            ...
            <div style={{ fontSize: '14px', marginBottom: '20px' }}>
                ...
                <span style={{ color: '#4b5563', margin: '0 5px' }}>&gt;</span>
                <span style={{ color: '#4b5563' }}>Tran-2 Offline Tools</span>
            </div>
            ...
            <div style={{ backgroundColor: '#fff', border: '1px solid #e5e7eb', borderTop: '3px solid #1eb3a6', padding: '30px', borderRadius: '4px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
                <ToolSection 
                    title="1. Tran-2 Inputs held on stock(Central) EXCEL template"
                    description="If you have large number of records in section 4 of Tran-2, Use this template to fill in the details and generate the JSON file for upload."
                />
                
                <ToolSection 
                    title="2. Tran-2 Credit on State Tax on the stock EXCEL template"
                    description="If you have large number of records in section 5 of Tran-2, Use this template to fill in the details and generate the JSON file for upload."
                />
            </div>
        </div>
    );
...
export default Tran2OfflineTools;
