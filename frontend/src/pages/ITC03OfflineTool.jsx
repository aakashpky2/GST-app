    ...
    return (
        <div style={{ backgroundColor: '#f1f3f6', padding: '20px 120px', minHeight: 'calc(100vh - 200px)' }}>
            ...
            <div style={{ fontSize: '14px', marginBottom: '20px' }}>
                ...
                <span style={{ color: '#4b5563', margin: '0 5px' }}>&gt;</span>
                <span style={{ color: '#4b5563' }}>ITC-03</span>
            </div>
            ...
            <div style={{ backgroundColor: '#fff', border: '1px solid #e5e7eb', borderTop: '3px solid #1eb3a6', padding: '30px', borderRadius: '4px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
                ...
                <h3 style={{ color: '#001b5c', fontSize: '18px', fontWeight: '600', marginTop: '30px', marginBottom: '15px' }}>
                    Who should fill GST ITC-03 form?
                </h3>
                <p style={{ color: '#333', lineHeight: '1.6', marginBottom: '15px', fontSize: '15px' }}>
                    You (the taxpayer) need to fill ITC-03 if:
                </p>
                <ul style={{ paddingLeft: '20px', lineHeight: '1.8', color: '#333', fontSize: '15px', marginBottom: '20px' }}>
                    <li style={{ listStyleType: 'disc', marginBottom: '5px' }}>you have opt for composition scheme or</li>
                    <li style={{ listStyleType: 'disc' }}>the goods or services or both supplied by you become wholly exempted and have availed Input Tax Credit (ITC)</li>
                </ul>

                <p style={{ color: '#333', lineHeight: '1.6', marginBottom: '15px', fontSize: '15px' }}>
                    While filing, you need to declare following goods and their values in ITC-03:
                </p>
                <ul style={{ paddingLeft: '20px', lineHeight: '1.8', color: '#333', fontSize: '15px', marginBottom: '30px' }}>
                    ...
                    <li style={{ listStyleType: 'disc', marginBottom: '5px' }}>Inputs contained in semi-finished and finished goods held in stock</li>
                    <li style={{ listStyleType: 'disc' }}>Capital goods held in stock</li>
                </ul>
                ...
                <ol style={{ paddingLeft: '20px', lineHeight: '1.8', color: '#333', fontSize: '15px', marginBottom: '30px' }}>
                    <li style={{ marginBottom: '15px' }}>
                        Download and prepare the ITC-03 form when offline.
                        <br />
                        <a href="#" style={{ display: 'inline-flex', alignItems: 'center', color: '#0056b3', textDecoration: 'none', fontWeight: '500', marginTop: '10px', fontSize: '15px' }}>
                            Download 
                        ...
                        <div style={{ marginTop: '15px', marginBottom: '15px' }}>
                            ...
                            <ul style={{ paddingLeft: '20px', lineHeight: '1.8', color: '#333', fontSize: '15px', listStyleType: 'disc' }}>
                                ...
                                <li>Double-click on <strong>ITC-03 Offline Tool</strong> to install the offline tool.</li>
                            </ul>
                        </div>
                    </li>
                    <li style={{ marginBottom: '8px' }}>Edit the generated file using import option.</li>
                    <li style={{ marginBottom: '8px' }}>Prepare ITC-03 using excel when offline (i.e. without Internet).</li>
                    <li style={{ marginBottom: '8px' }}>Generate the output file in .Json file format.</li>
                    <li style={{ marginBottom: '8px' }}>Using the output file, you can upload it in GST portal (www.gst.gov.in) when online.</li>
                </ol>

                <h3 style={{ color: '#001b5c', fontSize: '18px', fontWeight: '600', marginTop: '30px', marginBottom: '15px' }}>
                    Your downloaded (ITC-03 Offline Tool) zip file contains:
                </h3>
                <ul style={{ paddingLeft: '20px', lineHeight: '1.8', color: '#333', fontSize: '15px', marginBottom: '30px' }}>
                    <li style={{ listStyleType: 'disc', marginBottom: '5px' }}>ITC-03 excel</li>
...
export default ITC03OfflineTool;
