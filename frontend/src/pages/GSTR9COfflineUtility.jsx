        ...
        <div style={{ backgroundColor: '#f1f3f6', padding: '20px 120px', minHeight: 'calc(100vh - 200px)' }}>
            ...
            <div style={{ backgroundColor: '#fff', border: '1px solid #e5e7eb', borderTop: '3px solid #1eb3a6', padding: '30px', borderRadius: '4px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
                <h2 style={{ color: '#001b5c', fontSize: '24px', fontWeight: '500', marginTop: 0, marginBottom: '20px', borderBottom: '1px solid #e5e7eb', paddingBottom: '10px' }}>
                    GSTR-9C Offline Utility (v2.8)
                </h2>

                <p style={{ color: '#333', lineHeight: '1.6', marginBottom: '15px', fontSize: '15px' }}>
                    The excel based GSTR-9C offline utility is designed to help the taxpayer to prepare the auditor certified GSTR-9C reconciliation statement for financial years prior to FY 2020-21 in offline mode.
                </p>

                <p style={{ color: '#333', lineHeight: '1.6', marginBottom: '15px', fontSize: '15px' }}>
                    For FY 2020-21, taxpayer can use this tool to prepare the self-certified GSTR-9C reconciliation statement in offline mode.
                </p>

                <p style={{ color: '#333', lineHeight: '1.6', marginBottom: '20px', fontSize: '15px' }}>
                    The utility can be downloaded from this link.
                </p>
                ...
                <ul style={{ paddingLeft: '20px', lineHeight: '1.8', color: '#333', fontSize: '15px', marginBottom: '30px' }}>
                    <li style={{ listStyleType: 'disc' }}>GSTR_9C_Offline_Utility (Excel Macro)</li>
                ...
                <ul style={{ paddingLeft: '20px', lineHeight: '1.8', color: '#333', fontSize: '15px', listStyleType: 'none', margin: 0 }}>
                    ...
                    <li>2. Microsoft Excel 2010 & above</li>
                </ul>
            </div>
        </div>
    );
...
export default GSTR9COfflineUtility;
