    ...
    return (
        <div style={{ backgroundColor: '#f1f3f6', padding: '20px 120px', minHeight: 'calc(100vh - 200px)' }}>
            ...
            <div style={{ fontSize: '14px', marginBottom: '20px' }}>
                ...
                <span style={{ color: '#4b5563', margin: '0 5px' }}>&gt;</span>
                <span style={{ color: '#4b5563' }}>GST SRM-II</span>
            </div>
            ...
            <div style={{ backgroundColor: '#fff', border: '1px solid #e5e7eb', borderTop: '3px solid #1eb3a6', padding: '30px', borderRadius: '4px', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
                <h2 style={{ color: '#001b5c', fontSize: '24px', fontWeight: '500', marginTop: 0, marginBottom: '20px', borderBottom: '1px solid #e5e7eb', paddingBottom: '10px' }}>
                    GST SRM-II Offline Utility
                </h2>

                <p style={{ color: '#333', lineHeight: '1.6', marginBottom: '20px', fontSize: '15px' }}>
                    The Excel based GST SRM-II offline utility is designed to help the taxpayer to prepare GST SRM-II return offline. The utility can be downloaded from this link.
                </p>
                ...
                <p style={{ color: '#333', lineHeight: '1.6', marginBottom: '20px', fontSize: '15px' }}>
                    Before you extract and run the downloaded file, ensure that the file is not corrupted. How do I know that my file is not corrupt? Click <a href="#" style={{ color: '#0056b3' }}>here</a> to know more.
                </p>
                ...
                <h3 style={{ color: '#001b5c', fontSize: '18px', fontWeight: '600', marginTop: '10px', marginBottom: '15px' }}>
                    To access FAQs and User Manual of SRM-II
                </h3>
                <p style={{ color: '#333', lineHeight: '1.6', marginBottom: '20px', fontSize: '15px' }}>
                    Navigate to <span style={{ fontWeight: '500' }}>Help and Taxpayer Facilities &gt; GST Knowledge Portal &gt; GST Offline Tools &gt; Preparing SRM-II using Offline Utility</span>.
                </p>
            </div>
        </div>
    );
...
export default SRM2OfflineUtility;
