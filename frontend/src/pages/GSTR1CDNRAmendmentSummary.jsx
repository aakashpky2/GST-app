...
const GSTR1CDNRAmendmentSummary = () => {
    ...
    const handleAmend = async () => {
        ...
        // Search the database for the entered note number in saved CDNR records
        setLoading(true);
        try {
            ...
            if (res.data.success && res.data.data) {
                ...
                // Assuming the field might be noteNo or cdnurNo. We'll search both for safety, but typically it's noteNo.
                foundNote = notes.find(n => (n.noteNo || n.cdnrNo || n.invoiceNo || n.documentNo || '') === noteNo.trim());
            }

            if (foundNote) {
                // Navigate to the CDNR Amendment Details page and load the existing data for editing
                toast.success('Credit/Debit Note found! Navigating to amend details...');
                navigate('/returns/auth/gstr1/cdn/registered/amendment/details', { state: { invoice: foundNote } });
            } else {
        ...
        <div className="dashboard-container" style={{ backgroundColor: '#f1f3f6', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <div className="dashboard-breadcrumb-bar">
                <div className="breadcrumb-left">
                    ...
                    <span style={{ color: '#9ca3af', margin: '0 5px' }}>&gt;</span>
                    <span style={{ color: '#4b5563' }}>CDNRA</span>
                </div>
            ...
            <div className="gstr1-main-content" style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto', width: '100%', flex: '1' }}>
                ...
                <div className="b2b-header-banner" style={{ backgroundColor: '#14b8a6', padding: '10px 15px', color: '#fff', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: '15px' }}>
                    <h2 style={{ margin: 0, fontSize: '18px', fontWeight: '500' }}>9C - Amended Credit / Debit Notes (Registered)</h2>
...
export default GSTR1CDNRAmendmentSummary;
